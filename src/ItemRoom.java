...
public class ItemRoom extends Room implements RandCalculator{
...
//    protected ArrayList<Door> doors = new ArrayList();
    ...
    public ItemRoom(String name, double xPos, double yPos, int width, int height, int[][] map) {
    ...
    public void generateItem()
    {
        ...
        {
            upgrade.add(new UpgradeItem("bluepot.png", 89* 6, 89 * 4 - 20, 89, 120, 70, 0, 0, 0, 3, 0, "Blue Potion", "Take a swig     +Firerate"));
        }
        else if(randNum == 3)
        {
            upgrade.add(new UpgradeItem("meat.png", 89* 6, 89 * 4 - 20, 89, 120, 70, 2, 0, 0, 0, 0, "Meat", "Nutritous meal     +Health"));
        }
        else if(randNum == 4)
        {
        ...
        {
            upgrade.add(new UpgradeItem("bowarrow.png", 89* 6, 89 * 4 - 20, 89, 120, 70, 0, 30, 0, 0, 5, "Bow", "Useful utility     +Range +Damage"));
        }
        else if(randNum == 6)
        {
        ...
        {
            upgrade.add(new UpgradeItem("torch.png", 89* 6, 89 * 4 - 20, 89, 120, 70, 0, 0, 0, 0, 6, "Torch", "Burn the patriarchy!    ++Damage"));
        }
        else if(randNum == 14)
        {
    ...
    public void buildRoom(Player player) {
        ...
        {
            obstacles.add(new Bonfire("fire.png", 89 * 1, 89 * 3, 89, 89, 89));
            obstacles.add(new Bonfire("fire.png", 89 * 1, 89 * 5, 89, 89, 89));

            obstacles.add(new Bonfire("fire.png", 89 * 11, 89 * 3, 89, 89, 89));
            obstacles.add(new Bonfire("fire.png", 89 * 11, 89 * 5, 89, 89, 89));

            obstacles.add(new Bonfire("fire.png", 89 * 5, 89 * 1, 89, 89, 89));
            obstacles.add(new Bonfire("fire.png", 89 * 7, 89 * 1, 89, 89, 89));

            obstacles.add(new Bonfire("fire.png", 89 * 5, 89 * 7, 89, 89, 89));
            obstacles.add(new Bonfire("fire.png", 89 * 7, 89 * 7, 89, 89, 89));
        }
        generateItem();
    }
